    ...
    return (
        <div className="max-w-5xl p-6 mx-auto mt-10 md:-mt-40">
            <div className="justify-between md:flex">
                <div>
                    <Image src="/assets/logo-Fest.png" width={200} height={40} alt="Logo Bank" />
                    <Reveal>
                        <p className="mt-5 text-primaryDark max-w-[250px]">Una nueva forma de vivir la noche</p>
                    </Reveal>
                </div>
            ...
            <div className="items-center justify-between md:flex">
                <div className="my-3">
                    <Reveal>
                        2023 Full Fest. All Rights Reserved.
                    </Reveal>
                </div>
